	...
	<footer class="bg-dark">
        <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    <div class="flex md:justify-center lg:justify-start text-purple">
                        <svg
                            class="h-8"
                            viewBox="0 0 118 24"
                            fill="none"
                    ...
                    <p
                        class="mt-6 text-base font-body leading-relaxed md:text-center md:mx-auto md:max-w-xl lg:text-left text-white"
                    >
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt
                        consequuntur amet culpa cum itaque neque.
                    </p>
            
                    <ul class="flex md:justify-center lg:justify-start gap-6 mt-8 md:gap-8">
                        <li>
                        <a
                            href="/"
                            rel="noopener noreferrer"
                            target="_blank"
                            class="text-purple transition hover:text-purple"
                        >
                ...
                <div
                class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-7"
                >
                    <div class="text-left md:col-span-2">
                        <p class="text-lg font-medium font-head text-purple">About Us</p>
            
                        <nav class="mt-8">
                            <ul class="space-y-4 text-base font-body">
                                <li>
                    ...
                    <div class="text-left md:col-span-2">
                        <p class="text-lg font-medium font-head text-purple">Our Services</p>
                    ...
                    <div class="text-left md:col-span-3">
                        <p class="text-lg font-medium font-head text-purple">Contact Us</p>
            
                        <ul class="mt-8 space-y-4 text-base font-body">
                            <li>
                                <a
